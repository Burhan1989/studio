...
import { getLessons } from '@/lib/mockData'; // Changed to getLessons
...
export default function LessonsListPage() {
  const lessons = getLessons(); // Use getLessons to fetch lesson data
    ...
    <div className="space-y-8">
      ...
      {lessons.length > 0 ? (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
         ...
         <p className="text-center text-muted-foreground">Belum ada pelajaran yang tersedia. Silakan tambahkan melalui panel admin.</p>
      )}
    </div>
  );
}
